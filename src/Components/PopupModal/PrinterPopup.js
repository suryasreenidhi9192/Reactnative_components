        ...
        return (
            ...
            <PopupModal visible={true}>
                ...
                <Header>
                    ...
                    <Text style={styles.bodyStyle}>Please Connect printer. Activation code(s) will be printed with this order.</Text>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity onPress={this._onPressButton} disabled={!isEnabled}>
